...
```text
out/release/LASPointCloudViewer-v1.1.0-windows-x64/
out/release/LASPointCloudViewer-v1.1.0-windows-x64.zip
```
...
3. 选择 tag `v1.1.0`
4. 标题填写 `v1.1.0`
5. 粘贴 `docs/releases/v1.1.0.md` 的内容
6. 上传 `LASPointCloudViewer-v1.1.0-windows-x64.zip`
7. 发布
