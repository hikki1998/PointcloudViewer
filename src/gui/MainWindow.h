...
class MeasurementAnalysisController;
class MeasurementPanelWidget;
class NavigationSettingsWidget;
class ProfileClassificationController;
class ProfileClassificationDock;
class ProfileClassificationWidget;
class ProjectExplorerController;
class ProjectExplorerDock;
class RouteController;
class RouteDetailsDock;
class SceneInspectorDock;
class SpanProfileDock;
...
private:
    ...
    void createWindowAndViewerConnections();
    void retranslateUi();
    void retranslateActionsAndBackstage();
    void retranslatePanelsAndRuntimeState();
    void openBackstagePage(QWidget* page);
    void hideBackstageView();
    void refreshBackstageRecentProjects();
    void refreshWelcomeWorkspace();
    void recordRecentDataFiles(const QStringList& filePaths);
    void scheduleWorkspaceThumbnailCapture();
    void captureWorkspaceThumbnails();
    bool isUsableWorkspaceThumbnail(const QImage& image) const;
    void removeRecentItem(const QString& filePath, bool projectItem);
    ...
    void openRecentDataFile(const QString& filePath);
    void appendRecentDataFile(const QString& filePath);
    void locateRecentItem(const QString& filePath);
    ...
    ProjectExplorerDock* projectDock_ = nullptr;
    ProjectExplorerController* projectExplorerController_ = nullptr;
    VisualizationPanelController* visualizationPanelController_ = nullptr;
    MeasurementAnalysisController* measurementAnalysisController_ = nullptr;
    RouteController* routeController_ = nullptr;
    TowerController* towerController_ = nullptr;
    TowerEditorWidget* towerEditorWidget_ = nullptr;
    IssueController* issueController_ = nullptr;
    IssueEditorWidget* issueEditorWidget_ = nullptr;
    MeasurementPanelWidget* measurementPanelWidget_ = nullptr;
    SceneInspectorDock* inspectorDock_ = nullptr;
    RouteDetailsDock* routeDetailsDock_ = nullptr;
    ...
    BackstageProjectPropertiesWidget* backstageProjectPropertiesWidget_ = nullptr;
    QWidget* backstageApplicationSettingsPage_ = nullptr;
    BackstageApplicationSettingsWidget* backstageApplicationSettingsWidget_ = nullptr;
    QWidget* backstageAboutPage_ = nullptr;
    BackstageAboutWidget* backstageAboutWidget_ = nullptr;

    DatasetSummaryWidget* datasetSummaryWidget_ = nullptr;
    ...
    ProfileClassificationWidget* profileClassificationGroupBox_ = nullptr;
    NavigationSettingsWidget* navigationSettingsWidget_ = nullptr;
    ...
    bool workspaceThumbnailCapturePending_ = false;
    bool workspaceThumbnailCaptureQueued_ = false;
    int workspaceThumbnailFramesToWait_ = 0;
    int workspaceThumbnailCaptureAttempts_ = 0;
    QString workspaceThumbnailProjectPath_;
    QStringList workspaceThumbnailDataPaths_;
    QStringList pendingRecentDataFiles_;
    bool pendingDataLoadResetsProject_ = false;
    bool loadingProjectFile_ = false;
